...
from tools import BaseTool as CrewAITool
from tools.base_tool import BaseTool
from tools.structured_tool import CrewStructuredTool
from tools.tool_types import ToolResult
from utilities import I18N, Printer
from knowledge.utilities.errors import AgentRepositoryError
from knowledge.utilities.exceptions.context_window_exceeding_exception import (
...
def load_agent_from_repository(from_repository: str) -> Dict[str, Any]:
    ...
    if from_repository:
        ...
        from cli.authentication.token import get_auth_token
        from cli.plus_api import PlusAPI
